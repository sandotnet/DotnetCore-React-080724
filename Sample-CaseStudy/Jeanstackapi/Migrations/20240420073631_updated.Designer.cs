...
namespace Jeanstackapi.Migrations
{
    ...
    [Migration("20240420073631_updated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jeanstackapi.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jeanstackapi.Entities.Order", b =>
                {
                    b.HasOne("Jeanstackapi.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Jeanstackapi.Entities.OrderDetail", b =>
                {
                    b.HasOne("Jeanstackapi.Entities.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Jeanstackapi.Entities.Product", "Product")
                        .WithMany()
